...
public class CreatePostingDialog extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        try {
            startLoadingState();
            RESTClientRequest.getDegreesList(this, com.lessonlearned.app.Singletons.Context.getUser().getSchoolId());
        }
                    ...
                    public void onClick(View view) {
                        try {
                            ...
                            if (price.length() == 0 || selectedCourses.size() == 0){
                                ...
                                RESTClientRequest.postPosting(degreeSelected, (Tutor) com.lessonlearned.app.Singletons.Context.getUser(),
    ...
    public void initCourseAutofill() {
        ...
        autocomplete.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (!duplicate){
                    Course selectedCourse = new Course(courseId, courseName, com.lessonlearned.app.Singletons.Context.getUser().getSchoolId());
